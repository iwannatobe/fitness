...
def add_plan_item(item_type, exercise_name, target_sets=None, target_reps=None, target_weight=None, target_weight_step=0, target_rep_step=0, target_distance=None, target_duration=None):
    today = date.today().isoformat()
    conn = get_db()
    conn.execute("INSERT INTO daily_plan (plan_date, item_type, exercise_name, target_sets, target_reps, target_weight, target_weight_step, target_rep_step, target_distance, target_duration) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", (today, item_type, exercise_name, target_sets, target_reps, target_weight, target_weight_step, target_rep_step, target_distance, target_duration))
    conn.commit(); conn.close()
